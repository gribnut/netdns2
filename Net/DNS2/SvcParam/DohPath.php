...
class Net_DNS2_SvcParam_DohPath extends Net_DNS2_SvcParam
{
    /*
    ...
    /*
    * Single-valued URI in relative form (see https://datatracker.ietf.org/doc/draft-ietf-add-svcb-dns/)
    */
    public $dohpath;
